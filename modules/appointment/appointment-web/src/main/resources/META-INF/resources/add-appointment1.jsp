...
<body>
	...
	<aui:form action="<%=addAppointmentActionURL%>" name="appointmentForm"
		...
		<div class="main-div">
			...
			<br>
			<center>
				<strong><h2 style="font-size: 35px; color: white;">Book
						An Appointment</h2></strong>
			</center>
			<br>
			...
			<aui:col>
				...
				<aui:col>
					<aui:select id="options" name="country" value="Select-Country"
						label="" showEmptyOption="false">
				...
				<aui:col>
					<aui:select id="edit-speciality" name="speciality"
						value="Select-Speciality" label="" showEmptyOption="false">
				...
				<aui:col>
					<aui:input label="" name="age" placeholder="Age" type="number" />
				</aui:col>
			</aui:col>
